...
pub async fn create(db: &Database, user_id: String, data: Placement) -> Result<String, String> {
...
pub async fn update(db: &Database, user_id: String, id: String, data: Placement) -> Result<String, String> {
